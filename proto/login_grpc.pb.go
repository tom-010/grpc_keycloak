...
func (c *loginServiceClient) Login(ctx context.Context, in *LoginData, opts ...grpc.CallOption) (*LoginResult, error) {
	out := new(LoginResult)
...
func (UnimplementedLoginServiceServer) Login(context.Context, *LoginData) (*LoginResult, error) {
...
func _LoginService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoginServiceServer).Login(ctx, req.(*LoginData))
	}
